...
class DenseCoAttn(nn.Module):
    def __init__(self, dim1, dim2, dropout):
        ...
        self.query1_linear = nn.Linear(dim1 + dim2, dim1) 
        self.query2_linear = nn.Linear(dim1 + dim2, dim2)
    ...
    def forward(self, value1, value2):
        ...
        query1 = self.query1_linear(joint)
        query2 = self.query2_linear(joint)

        key1 = self.key1_linear(value1)
        key2 = self.key2_linear(value2)
